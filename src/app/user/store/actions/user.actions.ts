...
export enum UserActionTypes {
  USER_LIST_ALL ='[User/API] Select All list Users',
  USER_LIST_ALL_SUCCESS ='[User/API] Load Users'
}
...
export const selectUsersList = createAction('[User/API] Select All list Users');